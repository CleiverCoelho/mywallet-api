...
`)||a.includes("\r")){for(let g=l,O=t.length;g<O;g++)if(t[g].trim()||`
...
\r`.includes(t[a]))return a+1}return 0}return c!==null?c+1:0}function Yn(e,t,...n){if(!n.length||n.length===1&&y(n[0]))return null;let r={mode:0};if(y(n[0])){let o=p(p({},r),(0,d.default)(n[0]));if(!o.mode)o.mode=0;else if(D(o.mode)&&o.mode.length===1&&"0123".includes(o.mode))o.mode=+o.mode;else if(!W(o.mode))throw new Error(`string-left-right/chompLeft(): [THROW_ID_01] the opts.mode is wrong! It should be 0, 1, 2 or 3. It was given as ${o.mode} (type ${typeof o.mode})`);return V("left",e,t,o,(0,d.default)(n).slice(1))}return D(n[0])?V("left",e,t,r,(0,d.default)(n)):V("left",e,t,r,(0,d.default)(n).slice(1))}function Xn(e,t,...n){if(!n.length||n.length===1&&y(n[0]))return null;let r={mode:0};if(y(n[0])){let o=p(p({},r),(0,d.default)(n[0]));if(!o.mode)o.mode=0;else if(D(o.mode)&&"0123".includes(o.mode))o.mode=Number.parseInt(o.mode,10);else if(!W(o.mode))throw new Error(`string-left-right/chompRight(): [THROW_ID_02] the opts.mode is wrong! It should be 0, 1, 2 or 3. It was given as ${o.mode} (type ${typeof o.mode})`);return V("right",e,t,o,(0,d.default)(n).slice(1))}return D(n[0])?V("right",e,t,r,(0,d.default)(n)):V("right",e,t,r,(0,d.default)(n).slice(1))}return mt(zn);})();
/**
 * @name codsen-utils
